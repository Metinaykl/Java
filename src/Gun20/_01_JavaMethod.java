...
public class _01_JavaMethod {
    public static void main(String[] args) {
        ...
        toplamYaz(4,5); // giden var dönen yok (fonksiyonu birşeye eşitleyebiliyor musun?)
        int enb=Math.max(4,5); //giden var dönen var (fonksiyonu birşeye eşitleyebiliyor musun?)
