...
public class _01_StringBufferAndStringBuilder {
    public static void main(String[] args) {
        ...
        cumle=cumle+"Bugun";
        cumle=cumle+"hava";
        cumle=cumle+"çok soguk";

        System.out.println("cumle = " + cumle);
        System.out.println("cumle.concat = " + cumle.concat("fakat dün sıcaktı"));
        System.out.println("cumle = " + cumle);
        cumle=cumle.concat("fakat dün sıcaktı"); // concat birleştirir atama ister
        System.out.println("cumle = " + cumle);
        ...
        sb=new StringBuilder("bugun hava çok soğuk "); // sıfırlandı ve ilk değer atandı
        System.out.println("sb = " + sb);
