...
public class MethodCozumler {
    ...
    public static void main(String[] args) {
        ...
        int[] nnnnn = findFrequency(numbers);
    ...
    public static int sesliler(String str)   //&& kosulların tamamını sağlanması gerekiyor -|| -
    // bir tane kosulun sağlanması yeterli
    {
        int count = 0;
        for (int i = 0; i < str.length(); i++) {

            if (str.charAt(i) == 'a' || str.charAt(i) == 'e' || str.charAt(i) == 'i'
                    || str.charAt(i) == 'o' || str.charAt(i) == 'u'||str.charAt(i)=='ö'
                    || str.charAt(i)=='ı'||str.charAt(i)=='ü') {
                count++;
            }
        }
        return count;
    ...
    public static void karakterleriYazdır(char char1, char char2) {
