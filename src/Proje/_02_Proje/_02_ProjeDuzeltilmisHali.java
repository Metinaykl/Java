package Proje._02_Proje;
import java.util.ArrayList;
import java.util.Arrays;
import java.util.List;
import java.util.Scanner;
public class _02_ProjeDuzeltilmisHali {
    public static void main(String[] args) {
        ...
        // Banka musterilerine ait banka hesap numaralari listesi tanimlayin...Her mustero 2 adet hesaba sahip olsun...
